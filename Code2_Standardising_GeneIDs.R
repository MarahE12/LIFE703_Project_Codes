...
## This code is standardising the gene IDs by converting the species specific gene ID to the respective orthogroup ID generated by OrthoFinder.
## The orthogroup ID's and the respective gene ID's are in the 'orthogroup.tsv' file editted to be specific to each species.
## The following code displayed is repeated for each species, with slight changes in the gene name extraction criteria.
